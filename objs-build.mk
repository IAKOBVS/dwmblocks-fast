...
src/blocks/ram.o: src/blocks/ram.c src/blocks/shell.o 
	$(CC) -o src/blocks/ram.o -c src/blocks/ram.c $(CFLAGS) $(CPPFLAGS)
src/blocks/obs.o: src/blocks/obs.c src/blocks/procfs.o 
...
src/blocks/audio.o: src/blocks/audio.c src/blocks/audio-alsa.o 
	$(CC) -o src/blocks/audio.o -c src/blocks/audio.c $(CFLAGS) $(CPPFLAGS)
src/blocks/gpu.o: src/blocks/gpu.c src/blocks/shell.o 
